  ...
  return (
    <div className='flex bg-blue-700 px-6 my-36 lg:px-12 mx-2 md:mx-20 rounded-lg'>
          ...
          <div className='w-1/2 py-6 md:py-24 md:pl-5 lg:px-10'>
              ...
              <button onClick={() => { Navigate('/login'); scrollTo(0,0)}} className='bg-white text-sm sm:text-base text-gray-600 rounded-full mt-6 px-8 py-3 hover:scale-105 transition-all duration-300'>Create Account</button>
          </div>
